...
#define DATE "built on: Thu Nov 10 15:00:00 2011 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','c','k',' ','-','m','a','r','c','h','=','x','8','6','-','6',
    '4',' ','-','m','t','u','n','e','=','g','e','n','e','r','i','c',
    ' ','-','O','2',' ','-','g',' ','-','p','i','p','e',' ','-','W',
    'p',',','-','D','_','F','O','R','T','I','F','Y','_','S','O','U',
    'R','C','E','=','2',' ','-','W','p',',','-','D','_','G','L','I',
    'B','C','X','X','_','A','S','S','E','R','T','I','O','N','S',' ',
    '-','f','e','x','c','e','p','t','i','o','n','s',' ','-','f','s',
    't','a','c','k','-','p','r','o','t','e','c','t','o','r','-','s',
    't','r','o','n','g',' ','-','g','r','e','c','o','r','d','-','g',
    'c','c','-','s','w','i','t','c','h','e','s',' ','-','f','a','s',
    'y','n','c','h','r','o','n','o','u','s','-','u','n','w','i','n',
    'd','-','t','a','b','l','e','s',' ','-','f','s','t','a','c','k',
    '-','c','l','a','s','h','-','p','r','o','t','e','c','t','i','o',
    'n',' ','-','f','c','f','-','p','r','o','t','e','c','t','i','o',
    'n',' ','-','D','O','P','E','N','S','S','L','_','U','S','E','_',
