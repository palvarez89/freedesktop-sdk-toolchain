...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/usr/i386-unknown-linux-gnu/lib32\"); SEARCH_DIR(\"/usr/x86_64-unknown-linux-gnu/lib32\"); SEARCH_DIR(\"/usr/lib/x86_64-linux-gnu\"); SEARCH_DIR(\"/usr/lib\"); SEARCH_DIR(\"/usr/i386-unknown-linux-gnu/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
